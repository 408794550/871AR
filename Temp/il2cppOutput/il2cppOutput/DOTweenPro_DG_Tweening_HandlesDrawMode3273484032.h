...
struct  HandlesDrawMode_t3273484032 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(HandlesDrawMode_t3273484032, ___value___1)); }
