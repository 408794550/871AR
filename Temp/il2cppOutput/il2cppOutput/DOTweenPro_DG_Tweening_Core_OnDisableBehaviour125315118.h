...
struct  OnDisableBehaviour_t125315118 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(OnDisableBehaviour_t125315118, ___value___1)); }
